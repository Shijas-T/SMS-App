...
public class ContactsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        arrayListAllContacts.add(new ContactsModel("Muhammed","Shijas","8281652366"));
        arrayListAllContacts.add(new ContactsModel("Muhammed","Zahir","7012926735"));
        arrayListAllContacts.add(new ContactsModel("Zahir","2","9744089375"));
        arrayListAllContacts.add(new ContactsModel("Test","1","9810153260"));
